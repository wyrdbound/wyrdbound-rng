...
class TestGenerator:
    ...
    def test_generator_generates_specified_number_of_names(self, fantasy_names_yaml_path):
    ...
    def test_generator_generates_names_within_length_limit(self, fantasy_names_yaml_path):
    ...
    def test_generator_with_different_segmenters(self, fantasy_names_yaml_path, sengoku_names_yaml_path):
